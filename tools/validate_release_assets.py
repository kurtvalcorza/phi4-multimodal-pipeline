...
# allow_remote_code opt-in after digest-verifying the pinned code files (MOD9/MOD10; see docs/WEIGHTS.md).
FORBIDDEN_PATTERNS_MODULE_EXEMPT: tuple[str, ...] = ("trust_remote_code enabled",)
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    184_557_520: "fp16 adapter.safetensors size, Kaggle runs v4 and v5 (run record)",
    392_245_504: "mm-eval/VizWiz-Captions@c4a6d89 data/val-00004-of-00005.parquet (dataset)",
}
